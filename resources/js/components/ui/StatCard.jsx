export default function StatCard({ label, value, icon }) {
    return (
        <div className="relative p-6 rounded-2xl bg-white dark:bg-[#0F0F10] border border-zinc-100 dark:border-zinc-800/80 overflow-hidden">
            ...
            <div className="h-[2px] w-6 mt-5 rounded-full bg-[#AF9460]/60" />
        </div>
    );
}
